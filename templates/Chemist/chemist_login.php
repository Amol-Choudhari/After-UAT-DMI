	...
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-12 text-center">
				<h4>Authorized Chemist Login</h4>
			</div>
		</div>
	</div>
</section>
								...
								<div class="row">
									<div class="col-7">
										<?php echo $this->Form->create(null, array('autocomplete'=>'off', 'id'=>'login_customer_form')); ?>
											<div id="error_chemist_id" class="text-red text-sm"></div>
											<div id="chemistid_indication" class="text-info"></div>

											<div class="input-group mb-3">
												<?php $this->Form->setTemplates(['inputContainer' => '{{content}}']); ?>
												<?php echo $this->Form->control('chemist_id', array('label'=>false, 'type'=>'text', 'id'=>'chemist_id', 'class'=>'form-control input-field', 'placeholder'=>'Chemist Id')); ?>
											...
											<div id="error_captchacode" class="text-red float-right text-sm"></div>
												...
												<div class="social-auth-links text-center d-flex col-12 m-0 p-0">
													<div class="col-6 p-0">
														<?php echo $this->Form->control('Submit', array('type'=>'submit', 'name'=>'submit','id'=>'login_customer_validation_call' ,'label'=>false,'class'=>'btn btn-success btn-block')); ?>
													</div>
													<div class="col-6 p-0">
