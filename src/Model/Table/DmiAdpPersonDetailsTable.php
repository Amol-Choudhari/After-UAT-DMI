<?php
	...
	class DmiAdpPersonDetailsTable extends Table{
		...
		public function savePersonDetails($customer_id,$forms_data){
			...
			}else{ $person_qualifi_details_doc = $edit_chemist_row_data['person_qualifi_details_doc']; }
			...
			}else{ $person_exp_details_doc = $edit_chemist_row_data['person_exp_details_doc']; }
			...
			}else{ $profile_pic = $edit_chemist_row_data['profile_pic']; }
			if(!empty($forms_data['signature_doc']->getClientFilename())){
                   
				$file_name = $forms_data['signature_doc']->getClientFilename();
				$file_size = $forms_data['signature_doc']->getSize();
				$file_type = $forms_data['signature_doc']->getClientMediaType();
				$file_local_path = $forms_data['signature_doc']->getStream()->getMetadata('uri');
			...
			else{ $signature_doc = $edit_chemist_row_data['signature_doc']; }
