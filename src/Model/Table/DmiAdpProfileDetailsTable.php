		...
		public function saveFormDetails($customer_id,$forms_data){
			...
			if($dataValidatation == 1 ){
				...
				if ($form_type == 'C') {
					...
					//file uploading
					if(!empty($forms_data['any_other_information_doc']->getClientFilename())){
						
						$file_name = $forms_data['any_other_information_doc']->getClientFilename();
						$file_size = $forms_data['any_other_information_doc']->getSize();
						$file_type = $forms_data['any_other_information_doc']->getClientMediaType();
						$file_local_path = $forms_data['any_other_information_doc']->getStream()->getMetadata('uri');
					...
					{ 
						$any_other_information_doc = $section_form_details[0]['any_other_information_doc'];
					}
